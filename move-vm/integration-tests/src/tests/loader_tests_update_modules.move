address 0x2 {
    module A {
        ...
        public fun new(f1: 0x2::B::S, f2: 0x2::C::S, f3: 0x2::D::S): S {
            Self::S { f1, f2, f3 }
        }

        public fun destroy(v: S): (0x2::B::S, 0x2::C::S, 0x2::D::S) {
            let S { f1: v1, f2: v2, f3: v3 } = v;
            (v1, v2, v3)
        }
		...
		public fun get_field_3(s: &S): 0x2::D::S {
            *&s.f3
        }
    }
